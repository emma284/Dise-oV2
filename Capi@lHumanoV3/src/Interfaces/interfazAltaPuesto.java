...
public class interfazAltaPuesto {
	 ...
	 * @return 
	 */
	public void InterfazAltaPuesto() {
		initialize();
	}
	...
	private void initialize() {
		...
		gestorCompetencias gdc= new gestorCompetencias();
		Vector<String> nombreDeCompetenciasGuardadas = gdc.obtenerNombreDeCompetencias();
		
		for(String s: nombreDeCompetenciasGuardadas){
		...
		aceptar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				gestorPuestos gdp = new gestorPuestos();
				
				correcto5=gdp.codigoExistente(cod);
				correcto6=gdp.nombreExistente(nombre);

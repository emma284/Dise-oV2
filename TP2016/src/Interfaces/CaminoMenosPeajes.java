...
import Logica.Peaje;
/**
 *Abre la ventana que permite al usuario ingresar los datos para obtener el camino con menos peajes dessde un peaje a otro. 
 * @author CAROLINA developers.
 *
 */
public class CaminoMenosPeajes extends JFrame implements ActionListener{
	...
	public CaminoMenosPeajes(Grafo grafo){
		
		this.grafoLocal = grafo;
		
		ventana.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		ventana.setTitle("El camino con menos peajes ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == aceptar){
			if(peaje1.getSelectedItem().equals("Seleccione uno") || peaje2.getSelectedItem().equals("Seleccione uno") ){
				...
				try{
					CaminoPeajes c = new CaminoPeajes(grafoLocal,(String)peaje1.getSelectedItem(), (String)peaje2.getSelectedItem());
				}
